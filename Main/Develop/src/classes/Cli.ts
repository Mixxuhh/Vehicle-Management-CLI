  ...
  findVehicleToTow(truck: Truck): void {
    inquirer
      ...
      .then((answers) => {
        ...
        if (Vehicle.selectedVehicleVin === truck.vin) {
        ...
        if (!vehicleToTow) {
          console.error("Selected vehicle to tow was not found.");
          this.performActions();
          return;
        }
      ...
      .then((answers) => {
        ...
        if (answers.action === "Print details") {
          ...
          if (selectedTruck) {
            ...
            console.error("the selcted vehicle is not a truck.");
          }
          // TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike
        } else if (answers.action === "Wheelie") {
          const selectedBike = this.vehicles.find(
            (vehicle) =>
              vehicle.vin === this.selectedVehicleVin &&
          ...
          if (selectedBike) {
            ...
            console.error("The selected vehicle is not a motorbike.");
          }
